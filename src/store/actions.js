...
export const COLLECTION_REPORT_ATTRIBUTE_SELECTOR = '*,diagnosis_available(label),data_use(label,uri),biobank(id,name,juridical_person,logo_link,country,url,contact,ressource_types,description,type_of_host,source_of_funding,target_population,year_of_establishment,ontologies_used,imaging_available,also_listed,logo),contact(title_before_name,first_name,last_name,title_after_name,email,phone),sub_collections(name,id,sub_collections(*),parent_collection,diagnosis_available(*),order_of_magnitude,materials,data_categories,number_of_donors,description,gene,timestamp),number_of_donors'
/**/
