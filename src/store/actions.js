...
/* Query Parameters */
export const COLLECTION_ATTRIBUTE_SELECTOR = 'collections(id,description,materials,diagnosis_available,name,type,number_of_donors,order_of_magnitude(*),order_of_magnitude_donors(*),size,sub_collections(*),parent_collection,quality(*),data_categories)'
