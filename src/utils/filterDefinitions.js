...
const filterDefinitions = (state) => [
  ...
  },
  {
    ...
    options: genericFilterOptions('rd_connect_ressource_types', 'ressource_types'),
    initiallyCollapsed: false,
  ...
  },
  {
    ...
    options: genericFilterOptions('rd_connect_material_types', 'material'), // dynamicMaterialFilter(),
  ...
  },
  {
    ...
    options: genericFilterOptions('rd_connect_countries', 'country'),
